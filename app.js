d3.queue()
  ...
  .defer(d3.csv, '/data/renewables/API_EG.FEC.RNEW.ZS_DS2_en_csv_v2.csv', formatter)
...
var yearObj = formatAllData(data);
//This will be refacotred to include D3.js nest, but for now many loops because why nat!!!//
//TODO: What does this do?//
    function formatAllData(data) {
      ...
      //Formatter will remove iterations that don't have complete datasets//
